...
ActiveRecord::Schema.define(version: 20160623034950) do
  ...
  add_index "users", ["uid", "refresh_token", "expires_at"], name: "index_users_on_uid_and_refresh_token_and_expires_at", using: :btree
